...
- **`MacroCommand'** – зберігає та виконує декілька команд разом як єдиний блок.
- **`Invoker'** – викликає команди та керує послідовністю виконання.
- **`Receiver'** – система, яка обробляє та застосовує команди до 3D-моделей.
