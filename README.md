...
🔹 **Учасники:**
- **ModelBuilder (Abstract Builder)** – визначає інтерфейс для створення 3D-моделей.
- **ConcreteModelBuilder (Concrete Builder)** – Реалізує кроки для створення сітки та застосування текстури.
- **Директор** – керує процесом побудови, гарантуючи, що моделі будуються структуровано.
