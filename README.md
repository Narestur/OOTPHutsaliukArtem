...
## **Memento**
**Memento** використовується для **збереження стану 3D-моделі** у певний момент часу, **без розкриття внутрішньої структури** об’єкта. Це дозволяє **повернутися до попереднього стану**, наприклад, для порівняння або відновлення після руйнівних змін. Це **не** механізм undo/redo, а **ручне збереження і відновлення**.
